...
// Use inline password hashing with a simple function
...
async function main() {
    ...
    for (const item of inventoryItems) {
        await prisma.inventoryItem.upsert({
            where: { id: inventoryItems.indexOf(item) + 1 },
            update: {},
            create: item,
        })
    }
    ...
    const expenses = [
        { description: 'Truck Fuel', amount: 320, category: ExpenseCategory.TRANSPORT, createdBy: admin.id },
        { description: 'Electricity Bill', amount: 1500, category: ExpenseCategory.UTILITIES, createdBy: admin.id },
        { description: 'Cement Bags Purchase', amount: 15000, category: ExpenseCategory.INVENTORY, createdBy: admin.id },
        { description: 'Lunch for Staff', amount: 450, category: ExpenseCategory.OTHER, createdBy: employee.id },
        { description: 'Delivery Fee', amount: 45, category: ExpenseCategory.TRANSPORT, createdBy: employee.id },
    ]
